    ...
    <div className="max-w-4xl mx-auto px-4 pb-20">
      ...
      <div className="flex items-center justify-between mb-6 mt-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Boss 戰</h1>
        ...
        <motion.button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-colors ${
            showHistory
              ...
              : 'bg-white text-red-500 border border-red-200 shadow-sm hover:bg-red-50'
          }`}
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-gray-500 text-sm">已擊敗</p>
              <p className="text-2xl font-bold text-amber-600">{defeatedBosses.length}</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-gray-500 text-sm">總攻擊次數</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-gray-500 text-sm">獲得獎勵</p>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-red-600 mb-4">戰鬥記錄</h3>
          ...
          {history.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">還沒有戰鬥記錄</p>
            </div>
          ) : (
            <div className="space-y-4">
              {history.map((boss) => (
                <motion.div
                  ...
                  className={`bg-white rounded-xl p-4 border shadow-sm ${
                    boss.isDefeated ? 'border-green-200' : 'border-red-200'
                  }`}
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-800">{boss.bossName}</h4>
                        <p className="text-gray-500 text-sm">{boss.month}</p>
                      </div>
                    </div>
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-2">本月無Boss</h3>
          <p className="text-gray-500">下個月會有新的挑戰！</p>
        </div>
      )}

      {/* Tips */}
      <motion.div
        className="mt-8 bg-white rounded-xl p-4 border border-purple-100 shadow-sm"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      >
        <h4 className="font-semibold text-purple-600 mb-2">💡 小提示</h4>
